...
vcmd'let g:nvim_tree_disable_netrw = 0'
vcmd'let g:nvim_tree_hijack_netrw = 0'
vcmd'let g:loaded_netrw = 1'
vcmd'let g:loaded_netrwPlugin = 1'
...
vcmd'nmap g-d lua vim.lsp.buf.definition()<CR>'
